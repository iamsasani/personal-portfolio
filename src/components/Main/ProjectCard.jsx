...
const ProjectCard = () => {
  return (
    <article id="projects" className="group overflow-hidden rounded-2xl border border-black/10 bg-white">
        ...
        <div className="flex flex-col justify-between p-6 md:p-8 lg:p-10">
          ...
          <div>
            ...
            <p className="mt-5 max-w-xl text-sm leading-7 text-[#666666] md:text-base">
              A responsive movie discovery platform built with React,
              featuring movie and TV show browsing, detailed content pages,
              search, genres and user authentication.
            </p>
